				...
				try {
					...
					switch (this.taskData.setup.mode) {
						case 'request':
							...
							break;
						case 'browser':
							await frontend.cart.addCart.bind(this)(this.taskData.setup.platform); //NEEDS TO BE CONFIGURED TO MATCH PARAMETER PLATFORM
							this.setStatus('CARTED PRODUCT', 'WARNING')();
							resolve();
							break;
						default:
		...
		async function runStage(callback) {
			if (this.shouldStop === true) {
				...
				try {
					...
					// 		await this.requestCaptcha();
					// 		// await pooky.getCookies();
					// 		this.setStatus('CHECKING OUT', 'WARNING')();
					// 		await backend.checkout.postCheckoutMobileEu.bind(this)();
					// 		this.setStatus('PROCESSING', 'WARNING');
					// 		this.checkoutAttempts++;
					...
					// 		break;
					// 	case 'browser-mobile':
					// 		await frontend.checkout.fillForm.bind(this)();
					// 		this.setStatus('PROCESSING', 'WARNING');
					// 		this.checkoutAttempts++;
					// 		callback.bind(this)();
					// 		this.checkoutTime = Date.now() - this.startTime;
					...
					// 		break;
					// 	case 'browser-desktop':
					// 		await frontend.checkout.fillFormDesktopEu.bind(this)();
					// 		this.setStatus('PROCESSING', 'WARNING');
					// 		this.checkoutAttempts++;
					// 		callback.bind(this)();
					// 		this.checkoutTime = Date.now() - this.startTime;
