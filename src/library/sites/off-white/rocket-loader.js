! function () {
  ...
  function x(t) {
    ...
    var r = new W(e, {
      ...
      docWriteSimulator: n,
      callback: function () {
        window.__cfRLUnblockHandlers = true, r.removePreloadHints(), P(t)
      }
    });
  ...
  instanceof Array && function (t, e) {
    ...
    function t() {
      var t = this;
      this.simulatedReadyState = "loading", this.bypassEventsInProxies = false, this.nativeWindowAddEventListener = window.addEventListener;
      try {
    ...
    return t.prototype.runOnLoad = function (t) {
      ...
      this.bypassEventsInProxies = true, this.simulatedReadyState = "interactive", l(document, "readystatechange"), this.bypassEventsInProxies = false
    }, t.prototype.simulateStateAfterDeferScriptsActivation = function () {
      var t = this;
      this.bypassEventsInProxies = true, l(document, "DOMContentLoaded"), this.simulatedReadyState = "complete", l(document, "readystatechange"), l(window, "load"), this.bypassEventsInProxies = false, window.setTimeout(function () {
